...
Expr = Sizzle.selectors = {
	...
	pseudos: {
		...
		"empty": function( elem ) {
			...
			// :empty is negated by element (1) or content nodes (text: 3; cdata: 4; company ref: 5),
								...
								mightThrow = function() {
									...
									if ( isFunction( then ) ) {
										...
										if ( special ) {
											then.call(
												returned,
												resolve( maxDepth, deferred, Idcompany, special ),
										...
										// Normal processors (resolve) also hook into progress
											...
											then.call(
												...
												resolve( maxDepth, deferred, Idcompany, special ),
												resolve( maxDepth, deferred, Thrower, special ),
												resolve( maxDepth, deferred, Idcompany,
													deferred.notifyWith )
											);
										}
